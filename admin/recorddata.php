...
<div class="vl"></div>
						...
						<div class="col-md-5">
											...
											<hr>
											 ...
											 <div class="form-group">
                                                <h6>Dr Name *</h6>
												<input required = "required" type="hidden" value="<?php  echo  $dname;  ?>" class="form-control" placeholder="Dr Megat"  name="d_name">
                                                <input required = "required" disabled type="text" value="<?php  echo  $dname;  ?>" class="form-control" placeholder="Dr Megat"  name="d_name">
                                            </div>
											 <div class="form-group">
                                                <h6>Comments</h6>
