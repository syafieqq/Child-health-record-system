                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Test Function</h4>
                                <p class="category">function tarikh Record - tarikh reminder</p>
                            </div>
                            <div class="content">
              <header> date format ex: 2010/11/23</header>
<br>
<form name="input" action="#" method="get" onsubmit="return false;" >
   <div id="reserve_form">
    ...
    <div id="pickup_date"><p>Start date:<input type="date" class="textbox" id="pick_date" name="pickup_date" onchange="cal()"></p></div>

    <div id="dropoff_date"><p>End date:<input type="date" class="textbox" id="drop_date" name="dropoff_date" onchange="cal()"/></p></div>

    <div id="numdays">Number of days:<input type="text" class="textbox" id="numdays2" name="numdays"/></div>
			...
			<div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Test Reminder</h4>
                                <p class="category">If duration = 7, email sent</p>
                            </div>
                            <div class="content">
							<form method="post" action="updatemail.php">
							<button type="submit" name="updatemail" class="btn btn-primary"><i class="glyphicon glyphicon-edit"></i> &nbsp; Update all</button>
							</form>
