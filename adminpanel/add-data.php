...
{		
	...
	{
		$fn = $_POST["bname$i"];
		$fn1 = $_POST["username$i"];	
		$fn2 = $_POST["password$i"];
$fn3 = $_POST["address$i"];		
		$sql="INSERT INTO users(bname,address,username,password,role) VALUES('".$fn."','".$fn3."','".$fn1."','".$fn2."','admin')";
		$sql = $db->query($sql);		
	}
    ...
    <div class="main-panel">
        ...
        <div class="content">
            <div class="container-fluid">
                <div class="card">
                    <div class="header">
                        <h4 class="title">Add New Vaccines</h4>
...
if(isset($_POST['btn-gen-form']))
{
	...
	for($i=1; $i<=$_POST["no_of_rec"]; $i++) 
	{
        ...
        <tr>
        <td><?php echo $i; ?></td>
        <td><input type="text" name="bname<?php echo $i; ?>" placeholder="Vaccine's name" class='form-control' required/></td>
		<td><select style = "width:70%;" class = "form-control" name = "address<?php echo $i; ?>" required = "required">
		...
		<td><input type="text" name="username<?php echo $i; ?>" placeholder="Vaccine's name" class='form-control' required/></td>
		<td><input type="text" name="password<?php echo $i; ?>" placeholder="Vaccine's name" class='form-control' required/></td>
